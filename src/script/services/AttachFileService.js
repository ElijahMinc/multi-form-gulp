document.addEventListener('DOMContentLoaded', () => {
  class AttachFileService {
    ...
    constructor(
      ...
      this.spinnerCVFile = this.$root.querySelector(
        '[data-attach-file-spinner]'
      );
      ...
      this.trashCVFileIcon = this.$root.querySelector(
        '[data-attach-file-trash]'
      );
  ...
  window.AttachFile = AttachFileService;
});
